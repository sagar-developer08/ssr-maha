const mainImg = "https://d3gelo9cifr8ed.cloudfront.net/assets/Blog/blogMain.jpg";
...
const FeaturedBlog1 = "https://d3gelo9cifr8ed.cloudfront.net/blog+featured+image1.webp";
const FeaturedBlog3 = "https://d3gelo9cifr8ed.cloudfront.net/blog+featured+image2.webp";
const FeaturedBlog2 = "https://d3gelo9cifr8ed.cloudfront.net/blog+featured+image3.webp";
const FeaturedBlog4 = "https://d3gelo9cifr8ed.cloudfront.net/blog+featured+image4.webp";
let blogs = [
  {
    page: "home",
    author: "Admin Smith",
    ...
    route: "hot-air-balloon-vs-helicopter-which-dubai-adventure-is-right-for-you",
    short_des: {
...
Meta Description: Wondering if you should opt for a helicopter tour or a hot air balloon ride during your time in Dubai? Discover the benefits of a balloon flight and make sure to book your place for an unforgettable sky high escapade.
    ...
    seo: {
      meta_title: "Hot Air Balloon vs. Helicopter: Best Dubai Adventure for You",
      meta_description: "Confused between a hot air balloon and a helicopter ride? Read our guide to choose the perfect adventure in Dubai. Pros, cons, and what to expect.",
      schema_markup: ""
    }
  },
  {
...
<p>Rooting for mesmerizing Dubai desert sunrise views? Schedule your ride with Maha Balloon Adventures today!</p>`,
    ...
    seo: {
      meta_title: "Best Way to See Dubai Desert | Hot Air Balloon Ride Benefits",
      meta_description: "Experience the magic of the Dubai desert like never before with a hot air balloon ride. Learn why it’s the ultimate way to see breathtaking views.",
      schema_markup: ""
    }
  },
  {
...
<p>Looking for a reliable hot air ballooning operator for your aerial adventure in Dubai? Book your ride today with Maha Balloon Adventures today!</p>
    ...
    seo: {
      ...
      meta_description: "Wondering when to book your hot air balloon ride in Dubai? Discover the best times of the year for breathtaking views and ideal weather.",
      schema_markup: ""
    }
  },
  {
...
<p>The hot air balloon ride in Dubai is an adventure where tranquillity and serenity meet excitement. Now that you have a complete beginner’s guide to hot air ballooning, it is time to try the activity. Partner with Maha Balloon Adventures, get assistance with Dubai hot air balloon preparation, and enjoy the adventure like never before.</p>
    ...
    seo: {
      ...
      meta_description: "New to hot air ballooning? Learn what to expect on your first Dubai adventure. From preparation to breathtaking views, here’s your complete guide.",
      schema_markup: ""
    }
  }
];
